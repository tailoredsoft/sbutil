##########################################################################################
# Derived from    : btpa_firmware_loader.py
...
def loadfirmware(port, baudrate, file_path, dev_type=None):
    ...
    try:
        ...
        if f.mode == 'rb':
            ...
            try:
                processor = uwf_processor.init_processor(dev_type, port, baudrate)
